<template>
  <el-page-header title="热点新闻编辑" @back="goBack">
    <template #content>
      <span class="text-large font-600 mr-3"> 编辑热点新闻 </span>
    </template>
  </el-page-header>
  <el-form
    ref="productFormRef"
  ...
  >
    ...
    <el-form-item label="热点新闻介绍" prop="introduction">
      <el-input
        resize="none"
        type="textarea"
        :rows="5"
    ...
    <el-form-item label="热点新闻细节" prop="detail">
      <el-input
        resize="none"
        type="textarea"
        :rows="5"
    ...
    <el-form-item>
      <el-button type="primary" @click="onSubmit">更新热点新闻</el-button>
    </el-form-item>
  </el-form>
</template>
...
export default {
  ...
  setup() {
    ...
    const productRules = reactive({
      ...
      introduction: [
        { required: true, message: "请输入热点新闻介绍", trigger: "blur" },
      ],
