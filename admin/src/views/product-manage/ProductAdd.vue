<template>
  <el-page-header title="热点新闻管理" icon="">
    <template #content>
      <span class="text-large font-600 mr-3"> 热点新闻 </span>
    </template>
  </el-page-header>
  <el-form
    ref="productFormRef"
  ...
  >
    ...
    <el-form-item>
      <el-button type="primary" @click="onSubmit">添加热点新闻</el-button>
    </el-form-item>
  </el-form>
</template>
...
export default {
  ...
  setup() {
    ...
    const productRules = reactive({
      ...
      introduction: [
        { required: true, message: "请输入新闻介绍", trigger: "blur" },
      ],
